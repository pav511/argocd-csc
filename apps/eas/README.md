...
Parent application to bootstrap Environmental Awareness Sytems CSC deployment
...
| indexed | object | `{"dimm":4,"dsm":3,"ess":3,"weatherstation":14}` | A dictionary of _name_: _length_ used for getting the correct indexed Helm values file |
| isSim | list | `[]` | The list of applications that are run as simulators |
| namespace | string | `"eas"` | The namespace for the child applications |
