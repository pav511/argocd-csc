...
Parent application to bootstrap Observatory Systems CSC deployment
...
| indexed | object | `{}` | A dictionary of _name_: _length_ used for getting the correct indexed Helm values file |
| isSim | list | `[]` | The list of applications that are run as simulators |
| namespace | string | `"obssys"` | The namespace for the child applications |
